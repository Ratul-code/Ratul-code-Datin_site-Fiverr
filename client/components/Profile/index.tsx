  ...
  return (
    <>
      ...
      <main className={`w-full max-w-[1200px] mt-[70px] mx-auto`}>
        ...
        <div
          onClick={() => router.back()}
          className="flex items-center gap-1 text-xl cursor-pointer mt-[80px] mb-4 w-max text-gray-500 font-semibold "
        >
        ...
        {!profile && myProfile ? (
          <div className="flex flex-col justify-between gap-5 items-center w-full py-7 px-6 rounded-lg shadow-2xl bg-gray-100">
            ...
            <div className="text-xl font-semibold text-center space-y-2 capitalize">
              <p>
                Welcome To the most successfull dating website. You currently
                have no profile.
              </p>
              <p>
                Create an awesome profile and expand your beauty and capability.
              </p>
            </div>
            <Button
              onClick={() => {
          ...
          <div className="flex flex-col justify-between gap-5 items-center w-full py-7 px-6 rounded-lg shadow-2xl bg-gray-100">
          <div>
            <AiOutlineWarning size={45} color={"#000"} />
          </div>
          <div>
            <p className="text-3xl font-semibold mt-5 text-secondary tracking-wider">
              {/* Hey There{" "}
              <span className="text-secondary">
                {user.firstname} {user.lastname} !
              </span>{" "} */}

              This user dont have a profile yet !!
            </p>
          </div>
          {/* <div className="text-xl font-semibold text-center space-y-2 capitalize">
            <p>
